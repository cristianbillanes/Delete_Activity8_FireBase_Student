package com.example.delete_activity8;
...
public class DAOStudent {
    ...
    private List<com.example.delete_activity8.Student> students = new ArrayList<>();
    public interface DataStatus{
        void DataIsLoaded(List<com.example.delete_activity8.Student> students, List<String> keys);
        void DateIsInserted();
        void DataIsDeleted();
        void DataIsUpdated();
    }
        ...
        mReferenceStudent.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                 ...
                 for(DataSnapshot keyNods: snapshot.getChildren()){
                    ...
                    com.example.delete_activity8.Student student = keyNods.getValue(com.example.delete_activity8.Student.class);
    ...
    public void addstudent(String idname,com.example.delete_activity8.Student student, final DataStatus dataStatus){
        String key = idname;
    ...
    public void updateStudent(String key, com.example.delete_activity8.Student student, final DataStatus dataStatus){
